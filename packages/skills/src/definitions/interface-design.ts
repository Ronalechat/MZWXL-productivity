...
export const interfaceDesign: Skill = {
  id: "interface-design",
  name: "Interface Design",
  description:
    "Build interface design with craft and consistency — dashboards, admin panels, SaaS apps, tools. Prevents design drift across sessions by establishing and persisting design decisions.",
  invocation: "/interface-design",
  source: "file",
  category: "frontend",
  content: `---
name: interface-design
